import 'package:amecanico/2-Vista/Cliente/NewSeleccionarCoche.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    fieldViewBuilder: (context, textEditingController,
                      ...
                      return TextField(
                        ...
                        decoration: const InputDecoration(
                          ...
                          labelText: 'Buscar por nombre/telefono y seleccionar',
                        ),
                      );
                    },
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Continuar', style: TextStyle(fontSize: 25)),
        icon: const Icon(
          Icons.arrow_forward,
          size: 30,
        ),
